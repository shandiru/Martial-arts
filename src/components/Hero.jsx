  ...
  return (
    <section className="relative min-h-screen flex items-center bg-black overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[90rem] mx-auto px-6 md:px-12 flex flex-col justify-center">
        {/* Heading Section */}
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between mt-0 max-md:text-center max-md:gap-10">
          {/* Left Text */}
          <div className="text-white max-w-md md:pt-28 pt-10">
            <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed mb-6 md:mb-8 max-md:px-2">
            ...
            <div className="relative inline-flex items-center rounded-full bg-neutral-900/70 backdrop-blur-sm px-3 py-2 border border-white/15 shadow-[0_6px_18px_rgba(0,0,0,.45)] overflow-hidden">
              ...
              <div className="ml-2 leading-none">
                ...
                <div className="mt-1 flex gap-0.5 text-yellow-400">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} viewBox="0 0 24 24" className="w-3 h-3 sm:w-3.5 sm:h-3.5 fill-current">
          ...
          {/* Right Heading — unchanged for desktop, responsive for mobile */}
          <div className="text-right max-md:text-center max-md:px-4">
            <h1 className="text-6xl md:text-8xl font-extrabold leading-[1.05] text-white mb-10 md:mb-14 max-md:text-4xl">
              UNLEASH YOUR <br className="max-md:hidden" />
              POTENTIAL
            </h1>
          </div>
        </div>
        ...
        {/* Bottom Row */}
        <div className="flex flex-col md:flex-row items-center justify-between mt-[-1rem] md:mt-[-2rem] max-md:mt-6 max-md:text-center">
          <div></div>
          <div className="flex flex-col md:flex-row items-center gap-3 md:gap-4 md:pr-10">
