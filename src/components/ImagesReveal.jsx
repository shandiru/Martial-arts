    ...
    <section className="bg-black text-white py-20 px-6 md:px-12 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto mb-16 text-center">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto">
          From sweat-dripping cardio to raw strength and technique — pick your grind and go all in.
        </p>
      </div>
      ...
      <div className="relative flex flex-wrap justify-center items-center gap-6 md:gap-10">
        {cards.map((card, i) => (
          ...
          >
            ...
            {/* Overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/40 to-transparent opacity-0 group-hover:opacity-100 rounded-2xl transition-all duration-500"></div>

            {/* Hidden Title + Button */}
            <div className="absolute inset-0 flex flex-col justify-end items-start p-6 opacity-0 translate-y-5 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
